  ...
  <div class="wrap">
      ...
      <div class="content">
          <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
            ...
            <div class="select-group">
               <span>密码</span>
               <a href="javascript:;" @click="resetDialogVisible = true">重置密码 </a>
            </div>
        ...
        <!-- 重置密码弹窗 -->
        <el-dialog  :visible.sync="resetDialogVisible" width="20%" top='40vh' center>
            <span>重置成功，重置为初始密码123456</span>
            <span slot="footer" class="dialog-footer">
                <el-button type="danger" @click="resetDialogVisible = false">确 定</el-button>
            </span>
        </el-dialog>
      </div>
  </div>
